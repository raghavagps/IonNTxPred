...
## 📚 Reference
**Rathore AS, Jain S, Mehta NK, Raghava GPS. A PLM-based method for predicting protein ion channel modulators for drug discovery and safety evaluation. Protein Sci. 2026 Jul;35(7):e70689. doi: 10.1002/pro.70689. PMID: 42321971; PMCID: PMC13282186.**
## Zenodo
...
- Download the **zip file** from [Download Page](https://webs.iiitd.edu.in/raghava/ionntxpred/download.php) or [Hugging Face](https://huggingface.co/raghavagps-group/IonNTxPred/tree/main) or [Zenodo](https://zenodo.org/records/15710074).
